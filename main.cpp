...
const unsigned      PYRAMID_GRANULARITY     = 10;
...
const unsigned      PLANE_GRANULARITY       = 30;
...
void InitD3D(HWND hWnd, IDirect3D9 **d3d, IDirect3DDevice9 **device)
{
    *d3d = Direct3DCreate9(D3D_SDK_VERSION);
    ...
    OK( (*device)->SetSamplerState(0, D3DSAMP_MINFILTER, D3DTEXF_LINEAR) );
    OK( (*device)->SetSamplerState(0, D3DSAMP_MIPFILTER, D3DTEXF_LINEAR) );
}
